...
export default async function page() {
  ...
  return (
    <div className="flex w-full bg-background px-4 pt-4">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div>
            ...
            <Table className="border border-border">
              ...
              <TableBody>
                {orders.map((order) => (
                  <TableRow key={order.id} className="bg-secondary">
                    <TableCell>
                    ...
                    <TableCell className="hidden text-foreground min-[480px]:table-cell">
                      <StatusDropdown
                        id={order.id}
